  ...
  public settings = {
    ...
    actions: {
      custom: [
        ...
        {
          name: 'deleteAction',
          title: '<i class="far fa-trash-alt" title="Eliminar" (click)="EliminarEntidad($event)"> Delete  </i>'
        }
      ],
      add: false,
      edit: true,
      ...
      this.servicioEntidades.traerEntidad(i).subscribe(
        res => {                
          ...
          //Si no me devuelve datos indico el Error por pantalla
            ...
            this.servicioGenerales.showWarning('Atención', "No se encontró Entidad");
          }     
        },
        err => {
          this.servicioGenerales.showError('Error', "Hubo un inconveniente al querer traer las Entidades.");
        }
      );   
    }
  }
